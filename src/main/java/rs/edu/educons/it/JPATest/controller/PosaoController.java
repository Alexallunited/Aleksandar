...
public class PosaoController {
	...
	public double calculatorBruto(@RequestParam("pStopa") double poreskaStopa, @RequestParam("doprinosi") double doprinosi,
			@RequestParam("satnica") double satnica, @RequestParam("sati") double sati) {
